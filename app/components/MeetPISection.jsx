        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-full md:w-2/3">
            <div className="text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary font-heading mb-4">About Dr. Richard Powell</h2>
            ...
            <div className="space-y-5 md:space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 my-5 md:my-6">
                <div className="bg-background-white p-4 md:p-5 rounded-lg shadow-md text-center" style={{
                  ...
                  <h4 className="font-bold text-lg md:text-xl mb-1 font-heading" style={{ color: '#14b8a6' }}>Physician Researcher</h4>
                ...
                <div className="bg-background-white p-4 md:p-5 rounded-lg shadow-md text-center" style={{
                  ...
                  <h4 className="font-bold text-lg md:text-xl mb-1 font-heading" style={{ color: '#14b8a6' }}>Cardiovascular Research</h4>
                  <p className="text-base md:text-lg text-text-secondary font-body font-semibold">Leading heart health clinical trials</p>
                </div>
                ...
                <div className="bg-background-white p-4 md:p-5 rounded-lg shadow-md text-center" style={{
                  ...
                  <h4 className="font-bold text-lg md:text-xl mb-1 font-heading" style={{ color: '#14b8a6' }}>Patient-Centered Care</h4>
                  <p className="text-base md:text-lg text-text-secondary font-body font-semibold">Dedicated to safe, compassionate research
                  </p>
                </div>
              </div>
