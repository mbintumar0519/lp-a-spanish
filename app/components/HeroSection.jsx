          ...
          <div className="hero-text order-1 lg:order-1">
            <div>
              <h1 style={{
                ...
                ¿Proteja su Corazón Antes de que Sea Demasiado Tarde?
              </h1>
              <p style={{
               ...
               <strong>¿Tiene Lp(a) alto?</strong> Este factor en su sangre puede aumentar hasta 3 veces el riesgo de un infarto. Su Lp(a) podría estar poniendo su corazón en riesgo. Hágase la prueba y descubra si califica para un estudio diseñado para prevenir un primer ataque cardíaco.
              </p>
